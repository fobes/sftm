...
int main()
{
	...
	{
	public:
		CSyncEndTask(sftm::CChainController& ñhainController) :sftm::CTask(ñhainController) {}
	...
	{
	public:
		CSyncMidTask(sftm::CChainController& ñhainController) :sftm::CTask(ñhainController) {}
	...
	{
	public:
		CSyncStartTask(sftm::CChainController& ñhainController) :sftm::CTask(ñhainController) {}
